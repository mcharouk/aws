...
File names generated in this directory
* aws-config-results.txt
* aws-credentials-results.txt
...
assume a role (we can use profile dynamoDBAdminRole, but this cmd shows what the profile activation does in background)
